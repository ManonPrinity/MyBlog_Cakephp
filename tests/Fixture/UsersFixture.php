...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        'user_is' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['user_is'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
